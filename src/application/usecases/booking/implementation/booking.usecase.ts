  ...
  async cancelBooking(id: string): Promise<BookingStatusDto | null> {
    ...
    if (refundPercentage > 0) {
      ...
      if (
        ...
        this._logger.log(
          'Agency credit is still PENDING, adjusting pending transaction',
          {
            bookingId: id,
        ...
        this._logger.log(
          'Agency credit is SUCCEEDED, deducting from current balance',
          {
            bookingId: id,
            agencyId: bookingEntity.agencyId,
            refundAmount,
      ...
      if (
        ...
        this._logger.log(
          'No refund but marking pending transaction as SUCCEEDED',
          {
            bookingId: id,
            agencyId: bookingEntity.agencyId,
          },
