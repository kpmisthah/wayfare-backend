...
export interface IBookingUseCase {
    createBooking(createBookingDto:BookingDto,userId:string):Promise<{booking:CreateBookingDto;clientSecret:string}|null>
    fetchBookings(userId:string):Promise<FetchBookingDto[]|null>
    getUserBookings(userId:string):Promise<(FetchUserBookingDto|undefined)[]>
