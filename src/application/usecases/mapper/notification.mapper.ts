...
export class NotificationMapper{
    static toNotificationDto(notifcationEntity:NotificationEntity):ResponseNotificationDto{
        return{
    ...
    static toNotificationsDto(notficationEntity:NotificationEntity[]):ResponseNotificationDto[]{
