...
export class SaveTrip implements ISaveTrip {
  ...
  async saveTrip(userId: string, response: SaveTripDto,startDate:string,visibility:boolean): Promise<TripDto> {
    console.log(startDate,'startDate in savetrip and',visibility,'in savTripp');
