...
export interface IConnectionRepository extends IBaseRepository<ConnectionEntity>{
...
//   updateStatus(id: string, status: string): Promise<ConnectionEntity>;
  findConnection(senderId: string, receiverId: string): Promise<ConnectionEntity | null>;
