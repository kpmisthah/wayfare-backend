...
export class ConnectionMapper {
    ...
    static toPrisma(connection:ConnectionEntity):Prisma.ConnectionRequestCreateInput{
        return {
    ...
    static toConnectDomains(connections:ConnectionWithUser[]):ConnectionEntity[]{
    ...
    static toListAcceptedConnection(connection:ConnectionWithAcceptedUser):ConnectionEntity{
        return new ConnectionEntity(
            connection.id,
            connection.senderId,
            connection.receiverId,
    ...
    static toListAcceptedConnectionsDomain(connections:ConnectionWithAcceptedUser[]):ConnectionEntity[]{
