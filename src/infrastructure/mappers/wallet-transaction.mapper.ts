...
export class WalletTransactionMapper {
    static toDomain(walletTransaction:WalletTransaction):WalletTransactionEntity{
    ...
    static toPrisma(walletTransactionEntity: WalletTransactionEntity): Prisma.WalletTransactionCreateInput {
    const prismaObj: Prisma.WalletTransactionCreateInput = {
        ...
        category: walletTransactionEntity.category as $Enums.WalletTransactionType,
    };

    if (walletTransactionEntity.bookingId) {
        prismaObj.booking = { connect: { id: walletTransactionEntity.bookingId } };
    }
